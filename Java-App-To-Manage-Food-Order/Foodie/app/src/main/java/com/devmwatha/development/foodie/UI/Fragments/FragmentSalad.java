...
public class FragmentSalad extends Fragment {
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
       ...
       // String url="http://syncsoft.or.ke/foodie/foodie/salad.php?page="+String.valueOf(requestCount)+"&hotelid="+1;

        String getArgument = getArguments().getString("id");

        String url="http://10.0.2.2/foodie/salad.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;

        // String url="http://syncsoft.or.ke/foodie/foodie/salad.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                foodItems.setImageUrl(json.getString(Configurations.SALAD_IMAGE_URL));
                foodItems.setFood_description(json.getString(Configurations.SALAD_DESCRIPTION));
                foodItems.setFood_name(json.getString(Configurations.SALAD_NAME));
                foodItems.setFood_type(json.getString(Configurations.SALAD_TYPE));
                foodItems.setFoood_price(json.getString(Configurations.SALAD_PRICE));
                foodItems.setFood_delivery_time(json.getString(Configurations.SALAD_TIMER));
