...
//Calling the method getdata again
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        String url="http://10.0.2.2/foodie/maincourse.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;

        // String url="http://syncsoft.or.ke/foodie/foodie/maincourse.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                foodItems.setImageUrl(json.getString(Configurations.MAIN__DRINK_IMAGE_URL));
                foodItems.setFood_description(json.getString(Configurations.MAIN__DRINK_DESCRIPTION));
                foodItems.setFood_name(json.getString(Configurations.MAIN__DRINK_NAME));
                foodItems.setFood_type(json.getString(Configurations.MAIN__DRINK_TYPE));
                foodItems.setFoood_price(json.getString(Configurations.MAIN__DRINK_PRICE));
                foodItems.setFood_delivery_time(json.getString(Configurations.MAIN__DRINK_TIMER));
