...
import com.devmwatha.development.foodie.UI.Activities.StoreHotelID;
...
public class FragmentDessert extends Fragment {
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        //the url to fetch data from the live server
       //String url="http://syncsoft.or.ke/foodie/foodie/desserts.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;

       String url="http://10.0.2.2/foodie/desserts.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;
       //the url to fetch data from the local server
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                foodItems.setImageUrl(json.getString(Configurations.DESSERT_IMAGE_URL));
                foodItems.setFood_description(json.getString(Configurations.DESSERT_DESCRIPTION));
                foodItems.setFood_name(json.getString(Configurations.DESSERT_NAME));
                foodItems.setFood_type(json.getString(Configurations.DESSERT_TYPE));
                foodItems.setFoood_price(json.getString(Configurations.DESSERT_PRICE));
                foodItems.setFood_delivery_time(json.getString(Configurations.DESSERT_TIMER));
