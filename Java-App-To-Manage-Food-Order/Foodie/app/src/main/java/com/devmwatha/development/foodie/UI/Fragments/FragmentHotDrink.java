 ...
 */
public class FragmentHotDrink extends Fragment {
...
// use this url for live data
        //String url="http://syncsoft.or.ke/foodie/foodie/hotdrinks.php?page="+String.valueOf(requestCount)+"&hotelid="+getArgument;

        //use this url to fetch data from the ocalhost
        String url="http://10.0.2.2/foodie/hotdrinks.php?page="+ String.valueOf(requestCount)+"&hotelid="+ getArgument;
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                foodItems.setImageUrl(json.getString(Configurations.HOT_DRINK_IMAGE_URL));
                foodItems.setFood_description(json.getString(Configurations.HOT_DRINK_DESCRIPTION));
                foodItems.setFood_name(json.getString(Configurations.HOT_DRINK_NAME));
                foodItems.setFood_type(json.getString(Configurations.HOT_DRINK_TYPE));
                foodItems.setFoood_price(json.getString(Configurations.HOT_DRINK_PRICE));
                foodItems.setFood_delivery_time(json.getString(Configurations.HOT_DRINK_TIMER));
